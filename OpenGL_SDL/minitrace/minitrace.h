...
void internal_mtr_raw_event_arg(const char *category, const char *name, char ph, void *id, mtr_arg_type arg_type, const char *arg_name, void *arg_value, double offset=0);
...
#define MTR_SCOPE(c, n, s) MTRScopedTrace ____mtr_scope(c, n, s)
...
#define MTR_SCOPE_I(c, n, s, aname, aintval) MTRScopedTraceArg ____mtr_scope(c, n, MTR_ARG_TYPE_INT, aname, (void*)(intptr_t)(aintval), s)
...
public:
	MTRScopedTrace(const char *category, const char *name, double offset=0)
		: category_(category), name_(name) {
		start_time_ = mtr_time_s()+offset;
	}
	~MTRScopedTrace() {
...
public:
	MTRScopedTraceArg(const char *category, const char *name, mtr_arg_type arg_type, const char *arg_name, void *arg_value, double offset=0)
		: category_(category), name_(name) {
		internal_mtr_raw_event_arg(category, name, 'B', 0, arg_type, arg_name, arg_value, offset);
	}
	~MTRScopedTraceArg() {
